...
/**
 * Get resource translation amount statistics of known languages
 * @param {string} project Transifex project slug
 * @param {string} resource Transifex resource slug
...
module.exports = {txPull, txPush, txResources, txResourcesObjects, txCreateResource, txAvailableLanguages, txGetResourceStatistics};
